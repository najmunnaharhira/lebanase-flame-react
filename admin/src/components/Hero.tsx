      ...
      <div className="relative container py-16 md:py-24 lg:py-32">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-start">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <span className="inline-flex items-center gap-1.5 bg-olive/90 text-primary-foreground px-3 py-1.5 rounded-full text-sm font-medium">
              <Star className="w-4 h-4 fill-gold text-gold" />
              4.9 Rating
            </span>
            <span className="inline-flex items-center gap-1.5 bg-gold text-charcoal px-3 py-1.5 rounded-full text-sm font-medium">
              5★ Hygiene Rated
            </span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-cream leading-tight mb-4">
            Authentic Lebanese
            <span className="block text-flame-glow">Flavours</span>
          </h1>

          <p className="text-lg md:text-xl text-cream/90 font-body mb-8 max-w-md">
            Freshly prepared mezze, grills, and wraps delivered to your door in Eltham & SE9
          </p>
          ...
          {/* Order Panel */}
          <div className="bg-background/95 backdrop-blur rounded-3xl p-6 shadow-card">
